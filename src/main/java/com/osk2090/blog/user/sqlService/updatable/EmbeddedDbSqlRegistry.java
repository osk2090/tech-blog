...
public class EmbeddedDbSqlRegistry implements UpdatableSqlRegistry {
    ...
    public void updateSql(String key, String sql) throws SqlUpdateFailureException {
        ...
        if (affected == 0) {
            throw new SqlUpdateFailureException(key + "에 해당하는 sql를 찾을수 없습니다.");
        }
    }

    @Override
    public void updateSql(final Map<String, String> sqlmqp) throws SqlUpdateFailureException {
    ...
    public String findSql(String key) throws SqlNotFoundException {
        try {
            ...
            throw new SqlNotFoundException(key + " 에 해당하는 sql를 찾을수 없습니다.", e);
        }
    }
}
